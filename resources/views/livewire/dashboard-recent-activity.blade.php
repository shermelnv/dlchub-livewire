...
>
    ...
    <div class="flex-1 max-h-[60vh] overflow-y-auto text-sm text-gray-600 dark:text-gray-300 bg-zinc-900 rounded-lg relative">

    <table class="w-full text-left border-collapse">
        <thead class="bg-neutral-100 dark:bg-zinc-700 text-xs uppercase sticky top-0">
            <tr>
                ...
                <tbody>
                    @forelse ($activities as $activity)
                        <tr >
                            <!-- Type -->
                            <td class="px-3 py-2 capitalize">{{ $activity->type }}</td>

                            <!-- Message -->
                            <td class="px-3 py-2">{{ $activity->message }}</td>
